...
if __name__ == "__main__":
    ...
    if args.upload or args.train_comment or args.train_nickname:
        helper = S3Helper(str(project_root_path), 'youtube-comment-predict')

    nickname_train_loops, nickname_train_epoches = 1, 5
    comment_train_loops, comment_train_epoches = 1, 5
